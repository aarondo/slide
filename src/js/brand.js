jQuery(document).ready(function($) {
	...
	BrandSlider = function(el){
		...
		brandSlider = $(el);
		nextSliderClick = brandSlider.find('.nextSliderClick');
		prevSliderClick = brandSlider.find('.prevSliderClick');
		brandwindow = $(window);
		...
		this.getImgWidth = function(){
			width = brandSlider.find('img').css('width');
		...
		this.checkifLast = function(){
			lastslide = (self.countItems() - slidesPerPage);
		...
		this.resize = function(){
			equivPos = position / self.getImgWidth();			
			self.setSlider();
